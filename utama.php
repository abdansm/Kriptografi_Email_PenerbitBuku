...
<body>
    ...
    <nav class="navbar fixed-top navbar-light" style="background-color: #3dbaf9;">
        <div class="container-fluid">
            <a class="navbar-brand" href="utama.php"><img src="img/el_mail_logo.svg" class="logo"> El-Mail | Pesan Masuk </a>
    ...
    <?php if (isset($_GET['pesan'])) {
        if ($_GET['pesan'] == "tersedia") {
            $pesan = "upload file gagal! file sudah tersedia!";
        }
        if ($_GET['pesan'] == "berhasil") {
            $pesan = "Pesan terkirim!";
        }
        if ($_GET['pesan'] == "gagal") {
            $pesan = "Pesan Gagal terkirim!";
        }
        if ($_GET['pesan'] == "ilegal") {
    ...
    <div class="container-sm">
        <table class="table table-secondary">
            ...
            $query = mysqli_query($konek, "Select `dari`, `subjek`, `waktu`, `id_pesan` , `status` from pesan where kepada = '$username' ORDER BY waktu");
